<%@ Page Language="C#" AutoEventWireup="true" CodeFile="webExplorerSolicitud.aspx.cs" Inherits="WebForms_webExplorerSolicitud" EnableEventValidation="false" Debug="true" MasterPageFile="~/WebForms/MasterPage.master" %>

<asp:Content ID="seccion1" ContentPlaceHolderID="Encabezado" runat="server">
     Explorardor de Personal
</asp:Content>
