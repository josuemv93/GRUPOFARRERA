...
public partial class WebForms_webCatEmpresas : System.Web.UI.Page
{
    ...
    {
        string cadenav = "Select * from Cat_Empresas";
    ...
    {
        GridView1.HeaderRow.Cells[0].Text = "ID_EMPRESA";
