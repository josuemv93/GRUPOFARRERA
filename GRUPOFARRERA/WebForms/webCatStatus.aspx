<%@ Page Language="C#" AutoEventWireup="true" CodeFile="webCatStatus.aspx.cs" Inherits="WebForms_webCatStatus" Debug="true" EnableEventValidation="false" MasterPageFile="~/WebForms/MasterPage.master" %>

<asp:Content ID="seccion1" ContentPlaceHolderID="Encabezado" runat="server">
     Catálogo de Status de Registros
</asp:Content>
