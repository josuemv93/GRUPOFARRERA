<%@ Page Language="C#" AutoEventWireup="true" CodeFile="webExplorerCredencial.aspx.cs" Inherits="WebForms_webExplorerCredencial" EnableEventValidation="false" MasterPageFile="~/WebForms/MasterPage.master" %>

<asp:Content ID="seccion1" ContentPlaceHolderID="Encabezado" runat="server">
     Explorardor de Credenciales
</asp:Content>
