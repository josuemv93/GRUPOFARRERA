...
public partial class WebForms_webCatPuesto : System.Web.UI.Page
{
    ...
    {
        GridView1.HeaderRow.Cells[0].Text = "ID_PUESTO";
        GridView1.HeaderRow.Cells[1].Text = "CONCEPTO";
    ...
    {
        string cadenav = "Select * from Cat_Puesto";
